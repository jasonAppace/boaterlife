...
class ColorResources {
  ...
  static Color getOnBoardingShadeColor(BuildContext context) {
    return colorDarkBlue;
  }

  static Color getHomeScreenBackgroundColor(BuildContext context) {
  ...
  static const Color colorDarkBlue = Color(0xFF001B30);
  static const Color colorLightBlue = Color(0xFFF0F4FF);
}
