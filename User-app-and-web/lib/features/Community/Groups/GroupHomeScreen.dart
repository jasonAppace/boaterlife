                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Image.asset(
                                    Images
                                        .ph_noPost, // Replace with your empty state image
                                    width: 227,
                                    height: 178,
                                  ),
                                  SizedBox(height: 3.h),
                      ...
                      : SliverPadding(
                          ...
                          sliver: SliverList(
                            delegate: SliverChildBuilderDelegate(
                                      ...
                                      Navigator.push(
                                        ...
                                        PageTransition(
                                          ...
                                          child: GroupFeedDetailScreen(
                                            groupID: widget.groupID,
                                            postID: model.allGroupPostsData
                                                    ?.data?[index].id ??
                                                0,
                                          ),
                                        ),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                              ...
                                              Container(
                                                ...
                                                child: ClipRRect(
                                                  ...
                                                  child: CachedNetworkImage(
                                                    imageUrl:
                                                        '${splashProvider.baseUrls!.customerImageUrl}/${model.allGroupPostsData?.data?[index].users?.image ?? ""}',
                                                    placeholder:
                                                        (context, url) =>
                                                            Container(
                                                      width: 44,
                                                                ...
                                                                ListTile(
                                                                  ...
                                                                  onTap:
                                                                    ...
                                                                    await model
                                                                      ...
                                                                      model.userToken ??
                                                                          "",
                                                                      model.allGroupPostsData?.data?[index]
                                                                              .id ??
                                                                          0,
                                                                      widget.groupID ??
                                                                          0,
                                          ...
                                          ExpandableTextWidget(
                                            ...
                                            fontSize:
                                                15, // Match CommunityScreen
                                            maxLines:
                                                3, // Match CommunityScreen
                                          ),
                                          SizedBox(height: 10),
                                          Divider(),
                                          SizedBox(height: 10),
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  TextWidget(
                                                    textValue:
                                                        '${model.allGroupPostsData?.data?[index].likes?.length ?? 0}',
                                              ...
                                              TextWidget(
                                                textValue:
                                                    '${model.allGroupPostsData?.data?[index].comments?.length ?? 0} comments',
                                                textColor: ColorUtils.grey3,
                                                fontFamily:
                              ...
                              childCount:
                                  model.allGroupPostsData?.data?.length ?? 0,
                            ),
                          ),
                        ),
                  SliverToBoxAdapter(
                    child: SizedBox(
                        height: 80), // Match CommunityScreen bottom padding
                  ),
                ],
              ),
            ),
            floatingActionButton: (model.allGroupDetailData?.data?.active == 0)
                ? Container(
                    ...
                    child: FloatingActionButton(
                      ...
                      shape: RoundedRectangleBorder(
                        borderRadius:
                            BorderRadius.circular(16), // Match CommunityScreen
                      ),
