...
class _SearchUserScreenState extends State<SearchUserScreen> {
  _searchUsers(String query, MainViewModel model) async {
    if (model.userSearchTF.text.isNotEmpty &&
        model.userSearchTF.text.length > 2) {
      await model.doSearchUser(
          context, model.userToken ?? "", model.userSearchTF.text);
    }
  }
                    ...
                    Expanded(
                      child: (model.allSearchUserData?.data?.isEmpty ?? false)
                          ...
                          : ListView.separated(
                                    ...
                                    Navigator.push(
                                      ...
                                      PageTransition(
                                        ...
                                        child: UserDetailScreen(
                                          userID: model.allSearchUserData
                                                  ?.data?[index].id
                                                  .toString() ??
                                              "0",
                                        ),
                                            ...
                                            ClipRRect(
                                              ...
                                              child: CachedNetworkImage(
                                                imageUrl:
                                                    ...
                                                    '${model.allSearchUserData?.data?[index].image ?? ""}',
                              ...
                              itemCount:
                                  model.allSearchUserData?.data?.length ?? 0,
                            ),
                    ),
                  ],
                ),
