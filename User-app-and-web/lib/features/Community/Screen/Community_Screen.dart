...
class _CommunityScreenState extends State<CommunityScreen> {
                      ...
                      RefreshIndicator(
                        ...
                        child: CustomScrollView(
                          slivers: [
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      itemCount: (model.allJoinedGroupsData
                                                  ?.data?.length ??
                                              0) +
                                          1,
                                      padding: const EdgeInsets.symmetric(
                            ...
                            if ((model.allSuggestedGroupsData?.data?.length ??
                                    0) >
                                0)
                              SliverToBoxAdapter(
                                child: Column(
                                  ...
                                  (context, index) {
                                    return Container(
                                      ...
                                      child: InkWell(
                                        ...
                                        child: Padding(
                                          padding: const EdgeInsets.all(16),
                                          child: _buildPostWidget(context,
                                              model, index, splashProvider),
                                        ),
                                      ),
                                    );
                                  },
                                  childCount: model
                                          .allNewsFeedPostsData?.data?.length ??
                                      0,
                                ),
                              ),
                            ),
  ...
  Widget _buildPostWidget(BuildContext context, MainViewModel model, int index,
                ...
                ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    placeholder: (context, url) => Container(
                      ...
                      child:
                          Icon(Icons.group, color: ColorUtils.grey, size: 16),
                    ),
          ...
          children: [
            Container(
              ...
              child: ClipRRect(
                ...
                child: CachedNetworkImage(
                  imageUrl:
                      '${splashProvider.baseUrls!.customerImageUrl}/${post?.users?.image ?? ""}',
                  placeholder: (context, url) => Container(
                    width: 44,
                    height: 44,
                    decoration: BoxDecoration(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 8),
                      TextWidget(
                        textValue: DateConverterHelper.convertToAgo(
                            post?.updatedAt ?? ""),
                        textColor: ColorUtils.grey3,
                        fontFamily: FontUtils.urbanistRegular,
                        fontSize: 12,
            ...
            child: ClipRRect(
              ...
              child: CachedNetworkImage(
                ...
                errorWidget: (context, url, error) => Container(
                  ...
                  child: Center(
                    child:
                        Icon(Icons.image_not_supported, color: ColorUtils.grey),
                  ),
                ),
                fit: BoxFit.cover,
            ...
            children: [
              Expanded(
                child: _buildActionButton(
                  ...
                  label: 'Like',
                  isActive: post?.likes?.any(
                          (like) => like.userId.toString() == model.userID) ??
                      false,
                  onTap: () async {
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      PageTransition(
                        ...
                        child: GroupFeedDetailScreen(
                          groupID: model
                                  .allNewsFeedPostsData?.data?[index].groupId ??
                              0,
                          postID:
                              model.allNewsFeedPostsData?.data?[index].id ?? 0,
                        ),
                      ),
                    );
                  },
