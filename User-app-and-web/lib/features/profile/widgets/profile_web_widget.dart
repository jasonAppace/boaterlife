                                ...
                                children: [
                                  Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                          width: 430,
                                          child: Selector<VerificationProvider,
                                                  bool>(
                                              selector: (context,
                                      ...
                                      child: CustomButtonWidget(
                                        ...
                                        onTap: () async {
                                          ...
                                          String email = widget
                                              ...
                                              '';
                                          String phoneNumber = '';
                                          if (!profileProvider.countryCode!
                                              .contains('+')) {
                                            phoneNumber =
                                                '+${profileProvider.countryCode}${widget.phoneNumberController?.text.trim() ?? ''}';
                                          } else {
                                            phoneNumber =
                                                '${profileProvider.countryCode}${widget.phoneNumberController?.text.trim() ?? ''}';
                                          }
                                          ...
                                          debugPrint(
                                              '--------------(Profile)--------------$phoneNumber');
                                          debugPrint(
                                              '--------------(Profile)--------------${profileProvider.countryCode}');
                                          debugPrint(
                                              '--------------(Profile)--------------${widget.phoneNumberController?.text.trim() ?? ''}');
