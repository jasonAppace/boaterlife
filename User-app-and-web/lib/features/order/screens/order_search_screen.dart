      ...
      return orderProvider.isLoading
          ...
          : CustomButtonWidget(
              ...
              onTap: () {
                ...
                if (orderId.isEmpty) {
                  showCustomSnackBar(
                      getTranslated('enter_order_id', context), context);
                  ...
                  if (ResponsiveHelper.isDesktop(context)) {
                    ...
                    context.go(RouteHelper.getOrderTrackingRoute(
                        context, int.parse(orderId), phoneNumber));
                  }
                }
              },
            );
...
class _OrderIdTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return CustomTextFieldWidget(
      ...
      inputType: TextInputType.phone,
      contentPadding: const EdgeInsets.symmetric(
          vertical: Dimensions.paddingSizeDefault, horizontal: 20),
    );
  }
}
