...
class CreateNewPasswordScreen extends StatefulWidget {
  ...
  const CreateNewPasswordScreen(
      {super.key, required this.resetToken, required this.userInput});
...
class _CreateNewPasswordScreenState extends State<CreateNewPasswordScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint(
        "-----------------------(CREATE NEW PASSWORD)----------${widget.resetToken} and ${widget.userInput}");
            ...
            SliverToBoxAdapter(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Image.asset(
                    Images.changePasswordBackground,
                    width: 142,
                    height: 142,
                  ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Center(
                            child: SizedBox(
                          width:
                              ResponsiveHelper.isDesktop(context) ? 300 : null,
                          child: CustomButtonWidget(
                            ...
                            onTap: () {
                              ...
                              if (password.isEmpty) {
                                ...
                                bool isNumber = EmailCheckerHelper.isNotValid(
                                    userInput ?? '');
                                ...
                                auth
                                    .resetPassword(userInput, widget.resetToken,
