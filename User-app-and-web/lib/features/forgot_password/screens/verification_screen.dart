...
class _VerificationScreenState extends State<VerificationScreen> {
  ...
  void initState() {
    ...
    debugPrint("----------------------(VERIFICATION SCREEN)------$isPhone");
    debugPrint(
  ...
  Widget build(BuildContext context) {
    ...
    final bool isFirebaseOTP =
        AuthHelper.isCustomerVerificationEnable(configModel) &&
            AuthHelper.isFirebaseVerificationEnable(configModel);
                              ...
                              child: Column(
                                children: [
                                  ...
                                  CustomAssetImageWidget(
                                    widget.fromPage == FromPage.forget.name
                                        ? Images.forgotVerificationBackground
                                        : isPhone
                                            ? Images
                                                .phoneVerificationBackgroundIcon
                                            : Images
                                                .emailVerificationBackgroundIcon,
                                    height: 120,
                                  ),
                                  const SizedBox(
                                  ...
                                  Padding(
                                    padding: EdgeInsets.symmetric(
                                        horizontal: size.width > 850 ? 20 : 39,
                                        vertical: 30),
                                            ...
                                            if (widget.fromPage ==
                                              ...
                                              if (isPhone &&
                                                ...
                                                verificationProvider
                                                  ...
                                                  if ((responseModel != null &&
                                                      ...
                                                      tempToken == null) {
                                                    debugPrint(
                                                        "-------------------AFTER VERIFY OTP-------------Remember Me : ${authProvider.isActiveRememberMe}");
                                                    debugPrint(
                                                        "-------------------AFTER VERIFY OTP-------------User Input : $userInput");
                                                    debugPrint(
                                                        "-------------------AFTER VERIFY OTP-------------Country Code : ${PhoneNumberCheckerHelper.getCountryCode(userInput)!}");
                                                      ...
                                                      String userCountryCode =
                                                          PhoneNumberCheckerHelper
                                                              .getCountryCode(
                                                                  userInput)!;
                                                      debugPrint(
                                                          "-------------------AFTER VERIFY OTP-------------Phone : ${PhoneNumberCheckerHelper.getPhoneNumber(userInput!, userCountryCode)}");
                                                  ...
                                                  authProvider.firebaseOtpLogin(
                                                    ...
                                                    AuthHelper
                                                        .isPhoneVerificationEnable(
                                                            configModel)) {
                                                  debugPrint(
                                                      "-----------------------(Verification Screen)---------------UserInput: $userInput");
                                                  verificationProvider
                                              ...
                                              if (isFirebaseOTP && isPhone) {
                                                ...
                                                verificationProvider
                                                  ...
                                                  if (value.isSuccess) {
                                                    debugPrint(
                                                        "-----(VERIFICATION SCREEN)--------UserInput : ${widget.userInput} and VerificationCode: ${verificationProvider.verificationCode}");
