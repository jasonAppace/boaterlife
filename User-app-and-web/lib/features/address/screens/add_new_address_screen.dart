...
class _AddNewAddressScreenState extends State<AddNewAddressScreen> {
  ...
  void _initLoading() async {
    ...
    addressProvider.setCountryCode(CountryCode.fromCountryCode(Provider.of<SplashProvider>(context, listen: false).configModel!.countryCode!).dialCode ?? '', countryCodeValue: Provider.of<SplashProvider>(context, listen: false).configModel!.countryCode?.toUpperCase());
    print('-----(FIRST COUNTRY CODE)-----${addressProvider.countryCode} | Country: ${addressProvider.selectedCountryCode}');
