...
class AddressProvider with ChangeNotifier {
  ...
  String? _countryCode;
  String? _selectedCountryCode; // Track country code for flag display (e.g., 'US', 'CA')
  ...
  void setCountryCode (String code, {bool isUpdate = false, String? countryCodeValue}){
    if(!code.contains('+')){
      _countryCode = "+$code";
    }else{
      _countryCode = code;
    ...
    if(countryCodeValue != null) {
      _selectedCountryCode = countryCodeValue;
    }
    if(isUpdate){
      notifyListeners();
    }
