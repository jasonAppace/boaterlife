            ...
            children: [
              if (configModel.googleMapStatus ?? false) ...[
                Consumer<LocationProvider>(
                  ...
                  return SizedBox(
                    height: ResponsiveHelper.isMobile(context) ? 168 : 250,
                        ...
                        children: [
                          GoogleMap(
                            ...
                            onMapCreated: (GoogleMapController controller) {
                              if (!widget.isUpdateEnable &&
                                  _controller != null) {
                                _checkPermission(() => locationProvider
                          ...
                          Positioned(
                            ...
                            child: InkWell(
                              onTap: () async {
                                bool a = await Navigator.of(context)
