                  ...
                  Expanded(
                    ...
                    selectedItemBuilder: (BuildContext context) {
                      return (splashProvider
                                  .deliveryInfoModelList?[
                                      checkoutProvider.branchIndex]
                    ...
                    value: selectedAreaID == null
                        ...
                        : splashProvider
                            .deliveryInfoModelList?[
                                checkoutProvider.branchIndex]
                            .deliveryChargeByArea!
                            .firstWhere((area) => area.id == selectedAreaID)
                            .id
                            .toString(),
                    ...
                    dropdownSearchData: DropdownSearchData(
                      ...
                      searchInnerWidget: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText:
                                getTranslated('search_zip_area_name', context),
                      ...
                      searchMatchFn: (item, searchValue) {
                        DeliveryChargeByArea areaItem = (splashProvider
                                    .deliveryInfoModelList?[
                                        checkoutProvider.branchIndex]
                                    .deliveryChargeByArea ??
                                [])
                            .firstWhere((element) =>
                                element.id.toString() == item.value);
