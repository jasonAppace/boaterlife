...
class _CreateAccountScreenState extends State<CreateAccountScreen> {
  ...
  void initState() {
    ...
    final String configCountryCode = Provider.of<SplashProvider>(context, listen: false).configModel!.countryCode ?? 'US';
    print('----(CREATE ACCOUNT SCREEN)---- Config Country Code: $configCountryCode');
    ...
    try {
      ...
      if (countryDialCodeMap.containsKey(_selectedCountryCode)) {
        ...
        print('----(CREATE ACCOUNT SCREEN)---- Using mapped dial code: $_countryDialCode');
      } else {
        _countryDialCode = CountryCode.fromCountryCode(_selectedCountryCode ?? "").dialCode;
        print('----(CREATE ACCOUNT SCREEN)---- Using parser dial code: $_countryDialCode');
      }
    } catch (e) {
      print('----(CREATE ACCOUNT SCREEN)---- Error parsing country code: $e, using default US (+1)');
      _countryDialCode = '+1';
    }
  }
               ...
               if(!ResponsiveHelper.isDesktop(context)) SliverAppBar(
                 ...
                 backgroundColor: Theme.of(context).cardColor,
                  ...
                  flexibleSpace: FlexibleSpaceBar(
                    background:  SignUpLogoWidget(countryCode: config.countryCode),
                  ),
                )
              ];
            },
            body: CustomScrollView(slivers: [
              ...
              SliverToBoxAdapter(child: Center(child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    if(ResponsiveHelper.isDesktop(context)) Center(child: SignUpLogoWidget(countryCode: config.countryCode)),
                        ...
                        CodePickerWidget(
                          onChanged: (countryCode) {
                            setState(() {
                              ...
                              print('----(CREATE ACCOUNT SCREEN)---- Country changed to: ${countryCode.code}, Dial code: ${countryCode.dialCode}');
                            });
                          },
