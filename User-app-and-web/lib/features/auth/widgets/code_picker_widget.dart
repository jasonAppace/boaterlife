...
class CodePickerWidget extends StatefulWidget {
  ...
  // New properties added to support newer country picker options
      ...
      builder: (context) => Center(
        child: Dialog(
          ...
          child: SelectionDialog(
            ...
            headerAlignment: widget.headerAlignment ?? MainAxisAlignment.start,
            headerTextStyle: widget.headerTextStyle ?? TextStyle(),
            topBarPadding: widget.topBarPadding ?? EdgeInsets.zero,
          ),
        ),
      ),
    );
