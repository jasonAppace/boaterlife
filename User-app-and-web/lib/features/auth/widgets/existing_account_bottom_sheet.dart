...
class _ExistingAccountBottomSheetState
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint(
        "--------------------------(EXISTING ACCOUNT)---------------UserInfoModel : ${widget.userInfoModel.toJson()} and Medium : ${widget.socialLoginMedium} and UserName : ${widget.socialUserName}");
            ...
            Expanded(
                ...
                child: Consumer<AuthProvider>(
                  ...
                  return CustomButtonWidget(
                    ...
                    onTap: () {
                      debugPrint(
                          "----------------------(EXISTING ACCOUNT BOTTOM SHEET)-------Email: ${widget.userInfoModel.email} and Medium: ${widget.socialLoginMedium}");

                      if (!authProvider.isLoading) {
                        Navigator.pop(context);
                        authProvider
                            .existingAccountCheck(context,
                          ...
                          debugPrint(
                              "--------------- EXISTING API RESPONSE - Message is ${responseModel?.message}");
                          if (responseModel != null &&
                            ...
                            RouteHelper.getOtpRegistrationScreen(
                                context, tempToken, widget.userInfoModel.email!,
